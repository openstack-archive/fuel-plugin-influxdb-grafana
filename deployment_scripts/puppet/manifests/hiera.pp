...
$ldap_group_search_base_dns = $influxdb_grafana['ldap_group_search_base_dn']
...
$ldap_editor_group_dn       = $influxdb_grafana['ldap_editor_group_dn']
...
lma::grafana::ldap::editor_group_dn: <%= @ldap_editor_group_dn %>
