...
#. Copy the RPM file to the Fuel Master node:
   ...
   .. code-block:: console
      ...
      [root@home ~]# scp influxdb_grafana-1.0-1.0.1-1.noarch.rpm \
...
#. Install the plugin using the `Fuel Plugins CLI
   ...
   .. code-block:: console
      ...
      [root@fuel ~]# fuel plugins --install influxdb_grafana-1.0-1.0.1-1.noarch.rpm
...
#. Verify that the plugin is installed correctly:
   ...
   .. code-block:: console
      ...
      ---|----------------------|---------|----------------
      1  | influxdb_grafana     | 1.0.1   | 4.0.0
